...
export default function CopsefieldAccountPage() {
    ...
    <div className="min-h-screen px-4 py-8">
      <div className="mx-auto max-w-md">
        ...
        <a
          ...
          className="mt-4 block w-full rounded-md border border-copsefield-accent px-3 py-2 text-center text-sm font-medium text-copsefield-accent"
        >
          Copsefield Settings
        </a>
        {isCompanyAdmin && (
